...
; This file was generated Mon Apr 03 19:44:15 2017
;--------------------------------------------------------
$name system
$optc51 --model-small
	R_DSEG    segment data
...
;------------------------------------------------------------
;------------------------------------------------------------
;	system.c:5: char _c51_external_startup (void) {
;	-----------------------------------------
;	 function _c51_external_startup
;	-----------------------------------------
__c51_external_startup:
	using	0
;	system.c:6: PCA0MD&=(~0x40) ;    // DISABLE WDT: clear Watchdog Enable bit
	anl	_PCA0MD,#0xBF
;	system.c:7: VDM0CN=0x80; // enable VDD monitor
	mov	_VDM0CN,#0x80
;	system.c:8: RSTSRC=0x02|0x04; // Enable reset on missing clock detector and VDD
	mov	_RSTSRC,#0x06
;	system.c:16: CLKSEL|=0b_0000_0011; // SYSCLK derived from the Internal High-Frequency Oscillator / 1.
	orl	_CLKSEL,#0x03
;	system.c:20: OSCICN |= 0x03; // Configure internal oscillator for its maximum frequency
	orl	_OSCICN,#0x03
;	system.c:23: SCON0 = 0x10;
	mov	_SCON0,#0x10
;	system.c:25: TH1 = 0x10000-((SYSCLK/BAUDRATE)/2L);
	mov	_TH1,#0x30
;	system.c:26: CKCON &= ~0x0B;                  // T1M = 1; SCA1:0 = xx
	anl	_CKCON,#0xF4
;	system.c:27: CKCON |=  0x08;
	orl	_CKCON,#0x08
;	system.c:40: TL1 = TH1;      // Init Timer1
	mov	_TL1,_TH1
;	system.c:41: TMOD &= ~0xf0;  // TMOD: timer 1 in 8-bit autoreload
	anl	_TMOD,#0x0F
;	system.c:42: TMOD |=  0x20;
	orl	_TMOD,#0x20
;	system.c:43: TR1 = 1; // START Timer1
	setb	_TR1
